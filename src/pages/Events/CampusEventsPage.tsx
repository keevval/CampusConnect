...
import { Calendar as CalendarIcon, MapPin, Users, Ticket, Filter, Search, PlusCircle, Sparkles, Clock, CheckCircle2, Share2, Tag, ShieldCheck, Heart, AlertCircle } from 'lucide-react';
...
const INITIAL_EVENTS: CampusEvent[] = [
  {
    ...
    description: '36-hour intensive hackathon assembling student developers, researchers, and mentors to build AI solutions for modern campus challenges.',
    isRSVPed: true,
  ...
  },
  {
    ...
    description: 'Distinguished lectures by visiting scholars exploring quantum algorithms in protein folding and molecular dynamics simulations.',
    isRSVPed: false,
  ...
  },
  {
    ...
    description: 'Competitive tournament showcases paired with hands-on game design workshops run by industry studio veterans.',
    isRSVPed: false,
  ...
  },
  {
    ...
    description: 'An evening celebrating global heritage with student musical ensembles, dance performances, and traditional cuisine tastings.',
    isRSVPed: true,
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-slate-400 mt-2 max-w-2xl text-sm leading-relaxed">
              Discover upcoming academic conferences, hackathons, cultural festivals, and student organization workshops across all campuses.
            </p>
          </div>
          ...
          <>
            ...
            {filteredEvents.length === 0 && (
              <div className="text-center py-16 bg-slate-900/40 rounded-3xl border border-slate-800/60">
                ...
                <h3 className="text-lg font-semibold text-slate-300">No events found matching criteria</h3>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-2xl w-full overflow-hidden shadow-2xl relative">
            <div className="h-44 bg-slate-800 relative">
              <img src={selectedEventModal.bannerUrl} alt={selectedEventModal.title} className="w-full h-full object-cover" />
            ...
            <div className="p-6 relative -mt-6">
              ...
              <p className="text-slate-400 text-sm mb-6 leading-relaxed">{selectedEventModal.description}</p>
              ...
              <div className="grid grid-cols-2 gap-4 bg-slate-950 p-4 rounded-2xl border border-slate-800 mb-6 text-xs">
                ...
                <div className="flex items-center gap-2 text-slate-300">
                  ...
                  <span>{selectedEventModal.registeredCount} / {selectedEventModal.capacity} Seats Claimed</span>
                </div>
                <div className="flex items-center gap-2 text-slate-300">
